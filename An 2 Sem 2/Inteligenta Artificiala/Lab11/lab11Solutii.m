...
% % nivelul ascuns pentru aproximarea func�iei f.
% 
% X = -1:0.05:1;
% t = sin(2*pi*X) + 0.1*randn(size(X));
% 
...
% % multimea de testare): �divideind�, �dividerand�, �divideint� �i �divideblock�.
% 
% clear
% 
% X = -1:0.05:1;
...
% % antrenare prezentati in fisierul Laborator11Detalii. Care este cel mai adecvat 
...
% % antrenare prezentati in fisierul Laborator11Detalii.
